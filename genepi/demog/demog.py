...
def calculate_r0(r0_params, annual_cycle, mean_COI):
    ...
    # if non-natural transmission rate is constant
    ...
    def r0_function(t, prob_mixed):
        ...
        def static_r0(current_r0):
            r0_scale = float(current_r0) / initial_r0
            r0 = base_reproduction_rate * r0_scale
            return r0
        ...
        def dynamic_r0(start_change_t, start_change_R0, end_change_t, end_change_R0, t):
            ...
            #r0_scale = start_change_R0 / initial_r0
            dr0 = 1.0 - float(end_change_R0) / start_change_R0 
        
            # t is entered in days
            slope =  dr0 / (end_change_t - start_change_t)
            dt = t - start_change_t
            
            r0 = base_reproduction_rate * (1- slope * dt) #* r0_scale 
            return r0
        ...
        if index == len(r0_params['year']):
            ...
            regime = r0_params['regime'][index]                    
            if regime == 'constant':
                r0 = static_r0(r0_params['r0'][index])
            else:
